...
| ----------------------- | -------------------------------------- | -------------------------------------------------------------------- |
| Client → API            | tampering, replay, credential theft    | Supabase Auth JWTs, short access tokens, idempotency, rate limits |
...
- Accessing protected endpoints without a verified Supabase access token
